...
import 'package:choy_ritur_golpo/app/ui/settings/widgets/setting_card.dart';
import 'package:choy_ritur_golpo/main.dart';
import 'package:choy_ritur_golpo/theme/theme_controller.dart';
import 'package:choy_ritur_golpo/app/utils/color_converter.dart';
                        ...
                        return SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                ...
                                onPressed: () {
                                  HomeWidget.requestPinWidget(
                                    ...
                                    qualifiedAndroidName:
                                        'com.tech_with_m.choy_ritur_golpo.OreoWidget',
                                  );
                                },
                              ),
                              /*
                              SettingCard(
                                elevation: 4,
                                icon: const Icon(IconsaxPlusLinear.glass),
                                text: 'Glass Theme',
                                switcher: true,
                                value: settings.glassTheme ?? true,
                                onChange: (value) async {
                                  settings.glassTheme = value;
                                  HiveMigrationHelper.saveSettings(settings);
                                  await WidgetManager.setTheme(
                                    isGlassTheme: value,
                                    useLightText: settings.useLightText ?? false,
                                  );
                                  setState(() {});
                                },
                              ),
                              if (settings.glassTheme ?? true)
                                SettingCard(
                                  elevation: 4,
                                  icon: const Icon(IconsaxPlusLinear.text),
                                  text: 'Light Text',
                                  switcher: true,
                                  value: settings.useLightText ?? false,
                                  onChange: (value) async {
                                    settings.useLightText = value;
                                    HiveMigrationHelper.saveSettings(settings);
                                    await WidgetManager.setTheme(
                                      isGlassTheme: settings.glassTheme ?? true,
                                      useLightText: value,
                                    );
                                    setState(() {});
                                  },
