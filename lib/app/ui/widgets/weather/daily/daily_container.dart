...
class _DailyContainerState extends State<DailyContainer> {
  ...
  Widget build(BuildContext context) {
    final splashColor = Colors.green.shade100;
          ...
          children: [
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: labelLarge?.copyWith(color: Colors.green.shade800),
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Text(
                  'weatherMore'.tr,
                  style: textTheme.titleMedium?.copyWith(color: Colors.green.shade800),
                  overflow: TextOverflow.ellipsis,
                ),
              ),
            ),
